...
// REMOVE THIS ONCE EVERYTHING ELSE IS IN PLACE! -- FOR NOW, THE BLACKBERRY PACKAGER USES IT!
public class JavaPackager2 extends AbstractPackager {
    private final String m_zipLoc;
    private final String m_iconInjectorLoc;

    public JavaPackager2() {
